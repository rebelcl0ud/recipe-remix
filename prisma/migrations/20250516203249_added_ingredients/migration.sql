...
INSERT INTO "new_Recipe" ("authorId", "content", "createdAt", "deletedAt", "id", "published", "title", "updatedAt") SELECT "authorId", "content", "createdAt", "deletedAt", "id", "published", "title", "updatedAt" FROM "Recipe";
DROP TABLE "Recipe";
